...
class RMC():
    ...
    def __init__(self, config):
        self.config = config
        self.tracker = 'RMC'
        self.source_flag = 'RMC'
        self.upload_url = 'https://retro-movies.club/api/torrents/upload'
        self.search_url = 'https://retro-movies.club/api/torrents/filter'
        self.signature = "\n[center][url=https://github.com/edge20200/Only-Uploader]Powered by Only-Uploader[/url][/center]"
        self.banned_groups = ["Oj", "3LTON", "4yEo", "ADE", "AFG", "AniHLS", "AnimeRG", "AniURL", "AROMA", "aXXo", "CM8", "CrEwSaDe", "DeadFish", "DNL", "ELiTE", "eSc", "FaNGDiNG0", "Flights", "FRDS", "FUM", "GalaxyRG", "HAiKU", "HDS", "HDTime", "INFINITY", "ION10", "iPlanet", "JIVE", "KiNGDOM", "LAMA", "Leffe", "LOAD", "mHD", "nHD", "NOIVTC", "nSD", "RARBG", "RDN", "REsuRRecTioN", "RMTeam", "SANTi", "SicFoI", "SPASM", "STUTTERSHIT", "Telly", "TM", "UPiNSMOKE", "WORLD", "WAF", "xRed", "XS", "YELLO", "YIFY", "YTS", "YTSMX", "ZKBL", "ZmN"]
        pass
    ...
    async def upload(self, meta, disctype):
        ...
        rmc_name = await self.edit_name(meta)
            ...
            try:
                ...
                if "data" in resp_json and resp_json["data"]:
                    await common.add_tracker_torrent(
                        ...
                        "https://retro-movies.club/torrents/" + str(resp_json["data"]),
                        headers=headers,
                        params=params,
    ...
    async def edit_name(self, meta):
        ...
        if meta['tag'] == "" or any(invalid_tag in tag_lower for invalid_tag in invalid_tags):
            for invalid_tag in invalid_tags:
                rmc_name = re.sub(f"-{invalid_tag}", "", rmc_name, flags=re.IGNORECASE)
            rmc_name = f"{rmc_name}-NoGroup"
    ...
    async def search_existing(self, meta, disctype):
        ...
        if meta.get('category') == "TV":
            ...
            meta['skipping'] = "RMC"
            return
        if meta.get('year', 0) > 2000:
            console.print('[bold red]Only movies from year 2000 or older are allowed.')
            meta['skipping'] = "RMC"
            return
        dupes = []
