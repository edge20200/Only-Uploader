...
class IHD:
    ...
    def __init__(self, config):
        ...
        self.upload_url = "https://infinityhd.net/api/torrents/upload"
        self.search_url = "https://infinityhd.net/api/torrents/filter"
            ...
            try:
                ...
                if "data" in resp_json and resp_json["data"]:
                    await common.add_tracker_torrent(
                        ...
                        "https://infinityhd.net/torrents/" + str(resp_json["data"]),
                        headers=headers,
                        params=params,
    ...
    async def edit_name(self, meta):
        ...
        if name_type == "DVDRIP":
            if meta.get("category") == "MOVIE":
                ...
                ihd_name = ihd_name.replace(f"{meta['source']}", f"{resolution}", 1)
                ihd_name = ihd_name.replace(
                    f"{meta['video_codec']}",
